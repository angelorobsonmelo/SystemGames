...
(function() {
	...
	app.controller('TaxaLimiteAdminCtrl', ['$scope', '$rootScope', '$location', '$modal', 'TaxaLimiteAdminFactory', 'jogo',  function($scope, $rootScope, $location, $modal, TaxaLimiteAdminFactory, jogo){
